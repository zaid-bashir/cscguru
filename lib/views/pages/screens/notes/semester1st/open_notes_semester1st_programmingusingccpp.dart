...
class OpenNotesSemester1stProgrammingUsingCCpp extends StatefulWidget {
  OpenNotesSemester1stProgrammingUsingCCpp({Key key, this.subjectCode})
      : super(key: key);

  String subjectCode;

  @override
  OpenNotesSemester1stProgrammingUsingCCppState createState() =>
      OpenNotesSemester1stProgrammingUsingCCppState();
}

class OpenNotesSemester1stProgrammingUsingCCppState
    extends State<OpenNotesSemester1stProgrammingUsingCCpp> {
  bool isLoading = false;
  ApiService apiService = ApiService();
  ApiResponse<List<NoteModel>> apiResponse;

  fetchNotes1stsemesterProgrammingUsingCCpp() async {
    setState(() {
      isLoading = true;
    });
    apiResponse = await apiService.getNotesProgrammingUsingCCpp();
    setState(() {
      isLoading = false;
    });
  }
  ...
  void initState() {
    super.initState();
    fetchNotes1stsemesterProgrammingUsingCCpp();
  }
